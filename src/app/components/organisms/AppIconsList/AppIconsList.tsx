  ...
  return (
    <>
      ...
      <AppWrapIcons title="Languanges">
        <Image src="/icons/4.svg" width={50} height={50} alt="icon" />
        <Image src="/icons/8.svg" width={50} height={50} alt="icon" />
        <Image src="/icons/11.svg" width={50} height={50} alt="icon" />
        <Image src="/icons/typeScript.svg" width={50} height={50} alt="icon" />
        <Image src="/icons/26.svg" width={50} height={50} alt="icon" />
        <Image
      ...
      <AppWrapIcons title="Frameworks">
        <Image src="/icons/35.svg" width={50} height={50} alt="icon" />
        <Image src="/icons/18.svg" width={50} height={50} alt="icon" />
        <Image
        ...
        />
        <Image src="/icons/29.svg" width={50} height={50} alt="icon" />
        <Image src="/icons/39.svg" width={50} height={50} alt="icon" />
        ...
        <Image
          ...
          className="bg-white p-[5px] rounded-lg shadow-md"
        />
        <Image src="/icons/sass.svg" width={50} height={50} alt="icon" />
        <Image
        ...
        <Image
          ...
          alt="icon"
        />
        <Image src="/icons/jest-plain.svg" width={50} height={50} alt="icon" />
        <Image
      ...
      <AppWrapIcons title="Software Tools">
        ...
        <Image src="/icons/Group-2.svg" width={50} height={50} alt="icon" />
        <Image src="/icons/windows.svg" width={50} height={50} alt="icon" />
        <Image
          ...
          alt="icon"
        />
        <Image src="/icons/32.svg" width={50} height={50} alt="icon" />
      </AppWrapIcons>
    </>
  );
};
